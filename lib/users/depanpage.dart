...
class _HomePageState extends State<HomePage> {
  ...
  Widget categories() {
    List list = ['Burger', 'Pizza', 'Cupcake', 'French Fries', 'Drink'];
    return SizedBox(
      height: 40,
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 22,
                  color: indexCategory == index ? Colors.pink : Colors.grey,
